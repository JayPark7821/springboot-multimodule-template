...
import static kr.jay.appmain.endpoint.v1.JoinUserController.*;
...
import kr.jay.appmain.endpoint.v1.ApiPathV1;
...
class JoinUserControllerImplTest {
	...
	void 정상적인_회원가입_요청을_하면_기대하는_응답을_반환한다() throws Exception {
		...
		final JoinUserRequest request =
			new JoinUserRequest("test-idToken", "test-nickName", OAuthProvider.GOOGLE);
